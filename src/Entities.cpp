...
namespace chickengame {
    void Entities::initialize(GameImplementation* game)
    {
        ...
        this->player1->addComponent<SpriteComponent>(player1Sprite, true, &chickengame::animations::animationMap, "IDLE", 5); //adds sprite (32x32px), path needed
    ...
    void Entities::createProjectile(Vector2D pos, Vector2D velocity, int scale, int range, int speed, const char* texturePath, Entity* owner)
    {
